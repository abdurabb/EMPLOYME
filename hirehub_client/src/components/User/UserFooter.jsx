            ...
            <footer className='bg-gray-300 mt-1 text-white'>
                <div className='md:flex text-black-500 md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] pt-4 '>
                    ...
                    <div>
                        ...
                        <h1 className='lg:text text-black 4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-size-md:w-2/5'><span className='text-black'> We are Helping You to get Good Jobs</span></h1>
